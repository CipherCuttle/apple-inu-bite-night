...
// include: /tmp/tmpbsgfvvb6.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build-wasm/openrealm.data';
      var REMOTE_PACKAGE_BASE = 'openrealm.data';
...
Module['FS_createPath']("/share", "fonts", true, true);
Module['FS_createPath']("/share", "warcraft-3", true, true);
Module['FS_createPath']("/share/warcraft-3", "TestUI", true, true);
Module['FS_createPath']("/share/warcraft-3/TestUI", "Models", true, true);
Module['FS_createPath']("/share/warcraft-3/TestUI", "Textures", true, true);
Module['FS_createPath']("/share/warcraft-3", "Units", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['FS_createDataFile'](name, null, data, true, true, true);
          ...
          Module['removeRunDependency']('datafile_build-wasm/openrealm.data');
      }
      Module['addRunDependency']('datafile_build-wasm/openrealm.data');
    ...
    loadPackage({"files": [{"filename": "/share/fonts/fixed_8x13.h", "start": 0, "end": 13565}, {"filename": "/share/warcraft-3/TestUI/Models/anim_pulse.mdx", "start": 13565, "end": 14993}, {"filename": "/share/warcraft-3/TestUI/Models/wasm_smoke_ground.mdx", "start": 14993, "end": 16289}, {"filename": "/share/warcraft-3/TestUI/Textures/wasm_smoke_ground.blp", "start": 16289, "end": 33845}, {"filename": "/share/warcraft-3/TestUI/Textures/wasm_smoke_unit.blp", "start": 33845, "end": 51401}, {"filename": "/share/warcraft-3/Units/UnitBalance.slk", "start": 51401, "end": 52335}, {"filename": "/share/warcraft-3/Units/UnitData.slk", "start": 52335, "end": 52487}, {"filename": "/share/warcraft-3/Units/UnitUI.slk", "start": 52487, "end": 52732}, {"filename": "/share/warcraft-3/Units/unitUI.slk", "start": 52732, "end": 52977}, {"filename": "/share/warcraft-3/config.cfg", "start": 52977, "end": 55296}], "remote_package_size": 55296});

  })();

// end include: /tmp/tmpbsgfvvb6.js
// include: /tmp/tmp8t74uneq.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmp8t74uneq.js
// include: /tmp/tmpj_m47hsa.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpj_m47hsa.js
...
function findWasmBinary() {
  return locateFile('openrealm.wasm');
}
...
var _TW_BrowserReset = Module['_TW_BrowserReset'] = makeInvalidEarlyAccess('_TW_BrowserReset');
var _TW_BrowserBuild = Module['_TW_BrowserBuild'] = makeInvalidEarlyAccess('_TW_BrowserBuild');
var _TW_BrowserSend = Module['_TW_BrowserSend'] = makeInvalidEarlyAccess('_TW_BrowserSend');
var _TW_BrowserCreepCount = Module['_TW_BrowserCreepCount'] = makeInvalidEarlyAccess('_TW_BrowserCreepCount');
var _TW_BrowserCreepCost = Module['_TW_BrowserCreepCost'] = makeInvalidEarlyAccess('_TW_BrowserCreepCost');
var _TW_BrowserCreepIncomeGain = Module['_TW_BrowserCreepIncomeGain'] = makeInvalidEarlyAccess('_TW_BrowserCreepIncomeGain');
var _TW_BrowserMaxCreeps = Module['_TW_BrowserMaxCreeps'] = makeInvalidEarlyAccess('_TW_BrowserMaxCreeps');
var _TW_BrowserOutboundCount = Module['_TW_BrowserOutboundCount'] = makeInvalidEarlyAccess('_TW_BrowserOutboundCount');
var _TW_BrowserPendingSendCount = Module['_TW_BrowserPendingSendCount'] = makeInvalidEarlyAccess('_TW_BrowserPendingSendCount');
var _TW_BrowserOutboundHitPoints = Module['_TW_BrowserOutboundHitPoints'] = makeInvalidEarlyAccess('_TW_BrowserOutboundHitPoints');
var _TW_BrowserStep = Module['_TW_BrowserStep'] = makeInvalidEarlyAccess('_TW_BrowserStep');
var _HLW_BrowserHeroMove = Module['_HLW_BrowserHeroMove'] = makeInvalidEarlyAccess('_HLW_BrowserHeroMove');
var _HLW_BrowserHeroAttack = Module['_HLW_BrowserHeroAttack'] = makeInvalidEarlyAccess('_HLW_BrowserHeroAttack');
var _HLW_BrowserHeroAbility = Module['_HLW_BrowserHeroAbility'] = makeInvalidEarlyAccess('_HLW_BrowserHeroAbility');
var _HLW_BrowserHeroEntity = Module['_HLW_BrowserHeroEntity'] = makeInvalidEarlyAccess('_HLW_BrowserHeroEntity');
var _HLW_BrowserHeroX = Module['_HLW_BrowserHeroX'] = makeInvalidEarlyAccess('_HLW_BrowserHeroX');
var _HLW_BrowserHeroY = Module['_HLW_BrowserHeroY'] = makeInvalidEarlyAccess('_HLW_BrowserHeroY');
var _HLW_BrowserCommandCount = Module['_HLW_BrowserCommandCount'] = makeInvalidEarlyAccess('_HLW_BrowserCommandCount');
var _HLW_BrowserNativeReplayVerify = Module['_HLW_BrowserNativeReplayVerify'] = makeInvalidEarlyAccess('_HLW_BrowserNativeReplayVerify');
var _HLW_BrowserReplaySnapshot = Module['_HLW_BrowserReplaySnapshot'] = makeInvalidEarlyAccess('_HLW_BrowserReplaySnapshot');
var _TW_BrowserReplayVerify = Module['_TW_BrowserReplayVerify'] = makeInvalidEarlyAccess('_TW_BrowserReplayVerify');
var _TW_BrowserSnapshot = Module['_TW_BrowserSnapshot'] = makeInvalidEarlyAccess('_TW_BrowserSnapshot');
...
function assignWasmExports(wasmExports) {
  ...
  assert(typeof wasmExports['TW_BrowserReset'] != 'undefined', 'missing Wasm export: TW_BrowserReset');
  assert(typeof wasmExports['TW_BrowserBuild'] != 'undefined', 'missing Wasm export: TW_BrowserBuild');
  assert(typeof wasmExports['TW_BrowserSend'] != 'undefined', 'missing Wasm export: TW_BrowserSend');
  assert(typeof wasmExports['TW_BrowserCreepCount'] != 'undefined', 'missing Wasm export: TW_BrowserCreepCount');
  assert(typeof wasmExports['TW_BrowserCreepCost'] != 'undefined', 'missing Wasm export: TW_BrowserCreepCost');
  assert(typeof wasmExports['TW_BrowserCreepIncomeGain'] != 'undefined', 'missing Wasm export: TW_BrowserCreepIncomeGain');
  assert(typeof wasmExports['TW_BrowserMaxCreeps'] != 'undefined', 'missing Wasm export: TW_BrowserMaxCreeps');
  assert(typeof wasmExports['TW_BrowserOutboundCount'] != 'undefined', 'missing Wasm export: TW_BrowserOutboundCount');
  assert(typeof wasmExports['TW_BrowserPendingSendCount'] != 'undefined', 'missing Wasm export: TW_BrowserPendingSendCount');
  assert(typeof wasmExports['TW_BrowserOutboundHitPoints'] != 'undefined', 'missing Wasm export: TW_BrowserOutboundHitPoints');
  assert(typeof wasmExports['TW_BrowserStep'] != 'undefined', 'missing Wasm export: TW_BrowserStep');
  assert(typeof wasmExports['HLW_BrowserHeroMove'] != 'undefined', 'missing Wasm export: HLW_BrowserHeroMove');
  assert(typeof wasmExports['HLW_BrowserHeroAttack'] != 'undefined', 'missing Wasm export: HLW_BrowserHeroAttack');
  assert(typeof wasmExports['HLW_BrowserHeroAbility'] != 'undefined', 'missing Wasm export: HLW_BrowserHeroAbility');
  assert(typeof wasmExports['HLW_BrowserHeroEntity'] != 'undefined', 'missing Wasm export: HLW_BrowserHeroEntity');
  assert(typeof wasmExports['HLW_BrowserHeroX'] != 'undefined', 'missing Wasm export: HLW_BrowserHeroX');
  assert(typeof wasmExports['HLW_BrowserHeroY'] != 'undefined', 'missing Wasm export: HLW_BrowserHeroY');
  assert(typeof wasmExports['HLW_BrowserCommandCount'] != 'undefined', 'missing Wasm export: HLW_BrowserCommandCount');
  assert(typeof wasmExports['HLW_BrowserNativeReplayVerify'] != 'undefined', 'missing Wasm export: HLW_BrowserNativeReplayVerify');
  assert(typeof wasmExports['HLW_BrowserReplaySnapshot'] != 'undefined', 'missing Wasm export: HLW_BrowserReplaySnapshot');
  assert(typeof wasmExports['TW_BrowserReplayVerify'] != 'undefined', 'missing Wasm export: TW_BrowserReplayVerify');
  assert(typeof wasmExports['TW_BrowserSnapshot'] != 'undefined', 'missing Wasm export: TW_BrowserSnapshot');
  ...
  _TW_BrowserReset = Module['_TW_BrowserReset'] = createExportWrapper('TW_BrowserReset', wasmExports['TW_BrowserReset'], 0);
  _TW_BrowserBuild = Module['_TW_BrowserBuild'] = createExportWrapper('TW_BrowserBuild', wasmExports['TW_BrowserBuild'], 4);
  _TW_BrowserSend = Module['_TW_BrowserSend'] = createExportWrapper('TW_BrowserSend', wasmExports['TW_BrowserSend'], 2);
  _TW_BrowserCreepCount = Module['_TW_BrowserCreepCount'] = createExportWrapper('TW_BrowserCreepCount', wasmExports['TW_BrowserCreepCount'], 0);
  _TW_BrowserCreepCost = Module['_TW_BrowserCreepCost'] = createExportWrapper('TW_BrowserCreepCost', wasmExports['TW_BrowserCreepCost'], 1);
  _TW_BrowserCreepIncomeGain = Module['_TW_BrowserCreepIncomeGain'] = createExportWrapper('TW_BrowserCreepIncomeGain', wasmExports['TW_BrowserCreepIncomeGain'], 1);
  _TW_BrowserMaxCreeps = Module['_TW_BrowserMaxCreeps'] = createExportWrapper('TW_BrowserMaxCreeps', wasmExports['TW_BrowserMaxCreeps'], 0);
  _TW_BrowserOutboundCount = Module['_TW_BrowserOutboundCount'] = createExportWrapper('TW_BrowserOutboundCount', wasmExports['TW_BrowserOutboundCount'], 1);
  _TW_BrowserPendingSendCount = Module['_TW_BrowserPendingSendCount'] = createExportWrapper('TW_BrowserPendingSendCount', wasmExports['TW_BrowserPendingSendCount'], 1);
  _TW_BrowserOutboundHitPoints = Module['_TW_BrowserOutboundHitPoints'] = createExportWrapper('TW_BrowserOutboundHitPoints', wasmExports['TW_BrowserOutboundHitPoints'], 1);
  _TW_BrowserStep = Module['_TW_BrowserStep'] = createExportWrapper('TW_BrowserStep', wasmExports['TW_BrowserStep'], 1);
  _HLW_BrowserHeroMove = Module['_HLW_BrowserHeroMove'] = createExportWrapper('HLW_BrowserHeroMove', wasmExports['HLW_BrowserHeroMove'], 3);
  _HLW_BrowserHeroAttack = Module['_HLW_BrowserHeroAttack'] = createExportWrapper('HLW_BrowserHeroAttack', wasmExports['HLW_BrowserHeroAttack'], 1);
  _HLW_BrowserHeroAbility = Module['_HLW_BrowserHeroAbility'] = createExportWrapper('HLW_BrowserHeroAbility', wasmExports['HLW_BrowserHeroAbility'], 1);
  _HLW_BrowserHeroEntity = Module['_HLW_BrowserHeroEntity'] = createExportWrapper('HLW_BrowserHeroEntity', wasmExports['HLW_BrowserHeroEntity'], 1);
  _HLW_BrowserHeroX = Module['_HLW_BrowserHeroX'] = createExportWrapper('HLW_BrowserHeroX', wasmExports['HLW_BrowserHeroX'], 1);
  _HLW_BrowserHeroY = Module['_HLW_BrowserHeroY'] = createExportWrapper('HLW_BrowserHeroY', wasmExports['HLW_BrowserHeroY'], 1);
  _HLW_BrowserCommandCount = Module['_HLW_BrowserCommandCount'] = createExportWrapper('HLW_BrowserCommandCount', wasmExports['HLW_BrowserCommandCount'], 0);
  _HLW_BrowserNativeReplayVerify = Module['_HLW_BrowserNativeReplayVerify'] = createExportWrapper('HLW_BrowserNativeReplayVerify', wasmExports['HLW_BrowserNativeReplayVerify'], 0);
  _HLW_BrowserReplaySnapshot = Module['_HLW_BrowserReplaySnapshot'] = createExportWrapper('HLW_BrowserReplaySnapshot', wasmExports['HLW_BrowserReplaySnapshot'], 0);
  _TW_BrowserReplayVerify = Module['_TW_BrowserReplayVerify'] = createExportWrapper('TW_BrowserReplayVerify', wasmExports['TW_BrowserReplayVerify'], 0);
  _TW_BrowserSnapshot = Module['_TW_BrowserSnapshot'] = createExportWrapper('TW_BrowserSnapshot', wasmExports['TW_BrowserSnapshot'], 0);
